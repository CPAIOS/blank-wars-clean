      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
          {playerTeam.characters.map((character, index) => (
            ...
            >
              ...
              {String(phase) === 'battle-cry' && battleCries.player1 && character.id === player1.id && (
                <motion.div
        ...
        <div className="lg:col-span-1 flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-lg text-gray-300">{String(phase).replace('_', ' ').toUpperCase()}</p>
        ...
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
          {opponentTeam.characters.map((character, index) => (
            ...
            >
              ...
              {String(phase) === 'battle-cry' && battleCries.player2 && character.id === player2.id && (
                <motion.div
