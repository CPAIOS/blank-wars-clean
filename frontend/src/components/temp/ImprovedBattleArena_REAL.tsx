...
import { useBattleChat } from '@/hooks/temp/useBattleChat';
import { useBattleEngineLogic } from '@/hooks/temp/useBattleEngineLogic';
import { usePsychologySystem } from '@/hooks/temp/usePsychologySystem';
import { useCoachingSystem } from '@/hooks/temp/useCoachingSystem';
import { useCardCollectionSystem } from '@/hooks/temp/useCardCollectionSystem';
import { useUIPresentation } from '@/hooks/temp/useUIPresentation';
import { useBattleSimulation } from '@/hooks/temp/useBattleSimulation';
import { useBattleRewards } from '@/hooks/temp/useBattleRewards';
import { useBattleFlow } from '@/hooks/temp/useBattleFlow';
import { useBattleCommunication } from '@/hooks/temp/useBattleCommunication';
import { useBattleEvents } from '@/hooks/temp/useBattleEvents';
import { useMatchmaking } from '@/hooks/temp/useMatchmaking';
import { useBattleTimer } from '@/hooks/temp/useBattleTimer';
